...
REID_SIMILARITY_THRESHOLD = 0.65     # High-precision multi-exemplar threshold
...
FUSION_HIGH_CONF_THRESHOLD = 0.65    # Tier 1 auto-association threshold
FUSION_MEDIUM_CONF_THRESHOLD = 0.50  # Tier 2 tentative association threshold
